...
export default function HeroContent() {
  return (
    <div className="flex text-center items-center justify-center md:text-start px-4 py-8 md:col-start-2 md:col-end-3 md:p-6">
      <div>
        ...
        <Link
          className={`${lusitana.className} md:antialiased md:font-light bg-black p-2 text-white rounded-2xl`}
          href="/products"
        >
          Discover More
        </Link>
